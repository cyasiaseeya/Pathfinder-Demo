          ...
          <div className="card">
            <div className="card-header">
              ...
              <div style={{ marginLeft: "auto", display: "flex", gap: 6 }}>
                <span className="pill"><span className="dot" style={{ background: "oklch(0.55 0.14 38)" }}/>Cognitive</span>
...
const TraitHistoryRow = ({ dim, student, index }) => {
  ...
  return (
    <div style={{
      ...
      background: isSpine ? "linear-gradient(90deg, oklch(0.95 0.04 50 / 0.5), transparent 70%)" : "transparent",
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ width: 6, height: 6, borderRadius: "50%", background: dim.group === "affective" ? "var(--accent)" : "oklch(0.55 0.14 38)" }}/>
        ...
        {projects.map((p, i) => (
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, maxWidth: 180 }}>
            ...
            <div style={{
              ...
              boxShadow: p.state === "active" ? "0 0 0 4px oklch(0.85 0.10 45 / 0.3)" : "none",
