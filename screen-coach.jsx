  ...
  return (
    <div className="content" style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) 340px", gap: 20, height: "calc(100vh - 56px)", paddingBottom: 0 }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "32px 64px", background: "var(--surface)" }}>
            <div style={{ maxWidth: 620, margin: "0 auto" }}>
              ...
              <div style={{
                ...
                background: "oklch(0.95 0.04 50 / 0.5)",
                border: "1px dashed oklch(0.78 0.10 45)",
      ...
      <aside style={{ display: "flex", flexDirection: "column", gap: 12, minHeight: 0 }}>
        {/* Why flagged */}
        <div className="card" style={{ background: "linear-gradient(180deg, oklch(0.96 0.03 50 / 0.6), var(--surface))" }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 8,
        cursor: "pointer",
        background: isAnchored ? "oklch(0.95 0.04 50 / 0.6)" : (myComments.length ? "var(--bg-elevated)" : "transparent"),
        border: isAnchored ? "1px solid oklch(0.78 0.10 45)" : "1px solid transparent",
