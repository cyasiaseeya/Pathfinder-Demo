  ...
  return (
    <div
      ...
      style={{
        ...
        gap: 12,
        cursor: "pointer",
        background: student.needsAttention ? "linear-gradient(90deg, rgba(244, 217, 236, 0.45), transparent 60%)" : "transparent",
        transition: "background 0.12s",
      }}
      onMouseEnter={e => e.currentTarget.style.background = student.needsAttention ? "linear-gradient(90deg, rgba(238, 210, 232, 0.6), var(--bg-sunken) 60%)" : "var(--bg-elevated)"}
      onMouseLeave={e => e.currentTarget.style.background = student.needsAttention ? "linear-gradient(90deg, rgba(244, 217, 236, 0.45), transparent 60%)" : "transparent"}
    >
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Sparkline data={student.voiceTrend} width={70} height={26} stroke="var(--ink-3)" fill={trendDelta > 0 ? "#A989DD" : "none"} accent={trendDelta > 5} />
      </div>
