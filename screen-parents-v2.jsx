      ...
      <div className="card" style={{ display: "flex", flexDirection: "column", minHeight: 0 }}>
        ...
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 14, overflowY: "auto" }}>
          ...
          <div>
            ...
            <div style={{ padding: 12, border: "1px solid rgba(196, 168, 236, 0.4)", borderRadius: 8, background: "rgba(248, 230, 244, 0.5)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                ...
                <Sparkline data={student.voiceTrend} width={60} height={24} stroke="var(--accent)" fill="#A989DD" accent/>
              </div>
