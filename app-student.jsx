    ...
    <div className="ark-app">
      <DesignCanvas>
        ...
        <DCSection id="core" title="Core Screens" subtitle="The student's journey through one project">
          ...
          <DCArtboard id="make" label="07 · Make the Video" width={1280} height={900}>
            <window.MakeScreen />
          </DCArtboard>
          <DCArtboard id="defend" label="08 · Defend & Reflect" width={1280} height={820}>
            <window.DefendScreen />
          </DCArtboard>
          <DCArtboard id="arketype" label="09 · Arketype" width={1280} height={820}>
