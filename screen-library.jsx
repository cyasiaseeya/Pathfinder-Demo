...
const LibraryScreen = ({ onNavigate }) => {
  ...
  return (
    <div className="content">
      ...
      <div style={{
        background: "linear-gradient(180deg, oklch(0.96 0.03 50 / 0.7), var(--bg-elevated))",
...
const ProjectCard = ({ project, highlighted, recHook, student }) => {
  ...
  return (
    <div className="card" style={{
      ...
      {recHook && (
        <div style={{ fontSize: 11, color: "var(--accent-ink)", padding: "6px 8px", background: "oklch(0.95 0.04 50 / 0.5)", borderRadius: 6, display: "flex", alignItems: "center", gap: 6 }}>
