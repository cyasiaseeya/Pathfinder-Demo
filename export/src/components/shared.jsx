...
function ArkBrand({ slash, slashEn }) {
  return (
    <div className="ark-brand">
      <img src={window.__resources?.markBlack || "assets/ark-mark-black.png"} alt="Ark" className="ark-mark-light" />
      <img src={window.__resources?.markWhite || "assets/ark-mark-white.png"} alt="Ark" className="ark-mark-dark" />
